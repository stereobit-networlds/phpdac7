        ...
        <div class="yamm navbar">
            ...
            <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                <ul class="nav navbar-nav">
				   <phpdac>shkategories.show_selected_tree use klist++1+++ins_left_nav+++megamenu-element.htm++++1</phpdac>					
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">TV &amp; Audio</a>
                        <ul class="dropdown-menu">
                            <li><phpdac>frontpage.include_part use /parts/navigation/megamenu-horizontal.php+++media-center</phpdac></li>
                        </ul>
                    </li>
