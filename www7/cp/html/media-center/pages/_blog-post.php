	 ...
	 <div class="container">
	 	...
	 	<div class="posts col-md-9">
	 		...
	 		<div class="post-entry">
	 			...
	 			<div class="clearfix">
	 				<phpdac>frontpage.include_part use /parts/section/blog-single-slider.php+++media-center</phpdac>
	 			</div><!-- /.clearfix -->
			...
			<phpdac>frontpage.include_part use /parts/section/blog-single-comments.php+++media-center</phpdac>

			<phpdac>frontpage.include_part use /parts/section/blog-single-reply.php+++media-center</phpdac>
