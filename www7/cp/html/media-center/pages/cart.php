            ...
            <div class="widget cart-summary">
                ...
                <div class="body">
                    ...
                    <div class="buttons-holder">
                        <a class="le-button big" href="<phpdac>rcserver.paramload use SHELL+urlbase</phpdac>/index.php?page=checkout" >checkout</a>
                        <a class="simple-link block" href="<phpdac>rcserver.paramload use SHELL+urlbase</phpdac>/index.php?page=home" >continue shopping</a>
                    </div>
                </div>
            </div><!-- /.widget -->
