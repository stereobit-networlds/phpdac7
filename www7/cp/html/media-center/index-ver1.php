		...
		<!--phpdac>cms.nvldac2 use cmsrt.MC_CURRENT_PAGE+cms.include_part_arg:/pages/<mc_page>_rtl.php|||media-center+cms.include_part_arg:/pages/<mc_page>.php|||media-center+klist|kshow|product|products|kfilter|search</phpda-->
		<!--phpdac>cms.nvldac2 use CMS.rtl+cms.include_part_arg:/pages/<mc_page>_rtl.php|||media-center+cms.include_part_arg:/pages/<mc_page>.php|||media-center+1</phpdac-->		
