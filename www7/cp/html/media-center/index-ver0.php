...
<html lang="<phpdac>cms.iso_language</phpdac>">
	<head>
	    ...
	    <title><phpdac>shtags.get_page_info use item+NULL</phpdac> <phpdac>cms.paramload use INDEX+company-name+1</phpdac></title>		
...
<phpdac>cms.include_partDb use fb-api+++js</phpdac>
	...
	<div class="wrapper">
		<!--hpdac>cms.nvldac2 use cmsrt.megamenu+cms.include_part:/mm/mega-menu.php|||media-center++</phpda-->
	    <!--hpdac>cms.nvldac2 use cmsrt.megamenu+cms.include_part:/parts/navigation/top-menu-bar-empty-space.php|||media-center+cms.include_part:/parts/navigation/top-menu-bar.php|||media-center+</phpda-->
	...
	<!--hpdac>cmsrt.nvldac2 use cmsrt.MC_CURRENT_PAGE+cms.include_part_arg:/parts/<mc_page>-side-select.php|||media-center++</phpda-->	
	<phpdac>cmsrt.nvldac2 use cmsrt.MC_CURRENT_PAGE+cms.include_part:/parts/addtocart-side-select.php|||media-center++addtocart</phpdac>	
