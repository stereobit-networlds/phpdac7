                ...
                <div class="span12">
                    ...
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> <phpdac>cms.slocale use _treemapattach</phpdac> <phpdac>rctreemap.currentSelectedTree</phpdac>
                            </h4>

							<div class="update-btn">
								<phpdac>rctreemap.selectFieldButton</phpdac>
                                <a href="<phpdac>rctreemap.selectFieldUrl</phpdac>" class="btn"><i class="icon-repeat"></i> Default</a>
                            </div>
                        </div>
                        <div class="widget-body">
                            ...
                            <form name="form1" method="post" action="#" id="form1">
                                        ...
                                        <tr>
                                            <td style="width: 35%">
                                                ...
                                                <select name="tlist[]" id="box1View" multiple="multiple" style="height:300px;width:75%">
                                                    <phpdac>rctreemap.getCurrentList</phpdac>
                                                </select><br/>
                                            ...
                                            <td style="width: 35%">
                                                ...
                                                <select name="mytreelist[]" id="box2View" multiple="multiple" style="height:300px;width:75%;">
													<phpdac>rctreemap.viewList</phpdac>
                                                </select><br/>
                                ...
                                <div class="mtop20">
									<phpdac>rctreemap.postSubmit use cpsavetree+Ok+btn</phpdac>
                                </div>
                            </form>
                            <!-- END DUAL SELECT-->
                        </div>
