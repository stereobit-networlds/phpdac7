         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
					...
					<!--METRO/INDEX-->
					<phpdac>rcediimport.selectLOG</phpdac>
					
                    <div class="widget box purple">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> <phpdac>cmsrt.slocale use _ediimport</phpdac></span>
                            </h4>
                        <span class="tools">
                        ...
                        <div class="widget-body">
                            <form id="tForm" method="post" action="cpediimport.php?t=cpdoedimport" class="form-horizontal">
								<input type="hidden" name="FormName" value="doediimport" />
								<input type="hidden" name="FormAction" value="cpdoediimport" />
								<input type="hidden" name="imp" value="<phpdac>rcediimport.currFile</phpdac>" />
								
                                <div id="tabsleft" class="tabbable tabs-left">
                                <ul>
                                    <li><a href="#tabsleft-tab1" data-toggle="tab"><span class="strong">Parameters</span> <span class="muted">Parameters</span></a></li>
                                ...
                                <div class="tab-content">									
                                    ...
                                    <div class="tab-pane" id="tabsleft-tab1">
										<h3><phpdac>rcediimport.currFile</phpdac></h3>
										<div class="control-group">
											<label class="control-label"><phpdac>cmsrt.slocale use _settings</phpdac></label>
											<div class="controls">
												<select id="settings" multiple="multiple" style="height:100px;width:100%;">
												<phpdac>rcediimport.currSettings</phpdac>
												</select>
											</div>
										</div>	
										<div class="control-group">
									...
									<div class="tab-pane" id="tabsleft-tab2">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<phpdac>rcediimport.viewMessages</phpdac>
												</select>
											</div>
										</div>										
                                    </div>
