...
<head>
   <meta charset="utf-8" />
   <title>e-Enterprise site analytics</title>
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            <!-- BEGIN PAGE CONTENT-->
			<phpdac>siteanalytics.select_timeline use analytics-timeline</phpdac>
            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="widget ">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Server time</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
                        </div>
                        <div class="widget-body">
							<div id="widgetIframe">
								<phpdac>siteanalytics.widget use VisitTime+getVisitInformationPerServerTime</phpdac>
							</div>
                        </div>
                    </div>
                </div>
                <div class="span6">
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"> </i> Local time</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
                        </div>
                        <div class="widget-body">
							<div id="widgetIframe">
								<phpdac>siteanalytics.widget use VisitTime+getVisitInformationPerLocalTime</phpdac>
							</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                <div class="span7">
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4><i class="icon-tasks"></i> Location</h4>
							<span class="tools">
								<a href="javascript:;" class="icon-chevron-down"></a>
							</span>
                        </div>
