...
<body style="margin:0;padding:0">
      ...
      <div class="sidebar-scroll">
		<div class="widget blue">
            <div class="widget-body">
				<phpdac>rccrmforms.formsTree</phpdac>
            </div>
		</div>				
      </div>		
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            <!-- BEGIN PAGE CONTENT-->
             <div class="row-fluid">
                 <div class="span12">
					<div id="crmformedit"><?METRO/INDEX?></div>					
                 </div>
             </div>
            <!-- END PAGE CONTENT-->
         </div>
   ...
   <script>
	function subdetails() {var str = arguments[0]; $('#crmformedit').load("cpcrmforms.php?t=cpcrmformdata&module="+str);}
