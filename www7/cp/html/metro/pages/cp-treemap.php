...
<body class="fixed-top" onLoad="init()">
  ...
  <!-- END JAVASCRIPTS -->
   <script>
	function ttree() {var str = arguments[0]; $('#crmform').load("cptreemap.php?t=cptreeframe&mode=tree&id="+str);}   
	function titems() {var str = arguments[0]; $('#crmform').load("cptreemap.php?t=cptreeframe&mode=items&id="+str);}
	function tcats() {var str = arguments[0]; $('#crmform').load("cptreemap.php?t=cptreeframe&mode=cats&id="+str);}	
   </script>  
