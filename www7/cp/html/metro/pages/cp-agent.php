...
<body class="fixed-top">
   ...
   <!-- END JAVASCRIPTS -->  
   <script>
    function agency() {var str = arguments[0]; $('#agentform').load("cpagent.php?t=cpagentload&id="+str);}
	function editagn() {var str = arguments[0]; $('#agentform').load("cpagent.php?t=cpagnfetch&id="+str);}
	function editagndiv() {var str = arguments[0]; $('#agentform').load("cpagent.php?t=cpagndivfetch&id="+str);}
   </script>
