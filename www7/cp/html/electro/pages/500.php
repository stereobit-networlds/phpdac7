<div id="content" class="site-content" tabindex="-1">
	<div class="container">
    	...
    	<nav class="woocommerce-breadcrumb"><a href="index.php"><phpdac>cms.slocale use _HOME</phpdac></a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Error 500</nav>
                            ...
                            <div class="sub-form-row inner-bottom-xs">
                                <div class="widget woocommerce widget_product_search">
                                    <form class="woocommerce-product-search" method="get" role="search">
                                        ...
                                        <input type="search" title="Search for:" name="input" value="" placeholder="Search Products…" class="search-field" id="woocommerce-product-search-field">
