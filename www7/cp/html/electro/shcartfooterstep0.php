    ...
    <div class="cart_totals ">
        ...
        <table class="shop_table shop_table_responsive">
            ...
            <tbody>
				...
				$ret.= "</th><td data-title=\"Subtotal\"><span class=\"amount\">$1$</span></td></tr>";
				return ($ret);	   
				?>	
				+
				</phpdac>				
				...
				$ret.= "</th><td data-title=\"Subtotal\"><span class=\"amount\">$2$</span></td></tr>";
				return ($ret);	   
				?>	
				+
				</phpdac>
				...
				$ret.= "</th><td data-title=\"Subtotal\"><span class=\"amount\">$3$</span></td></tr>";
				return ($ret);	   
				?>	
				+
				</phpda-->
				...
				$ret.= "</th><td data-title=\"Subtotal\"><span class=\"amount\">$5$</span></td></tr>";
				return ($ret);	   
				?>	
				+
				</phpdac>
				...
				$ret.= "</th><td data-title=\"Subtotal\"><span class=\"amount\">$6$</span></td></tr>";
				return ($ret);	   
				?>	
				+
				</phpdac>
				...
				<tr class="order-total">
                    ...
                    <td data-title="Total"><strong><span class="amount"><phpdac>shcart.getcartTotal use +1</phpdac> &euro;</span></strong> </td>
                </tr>


                <tr class="shipping">
                    <th>Shipping</th>
                    <td data-title="Shipping">Flat Rate: <span class="amount">$300.00</span> 
                        ...
                        <div class="woocommerce-shipping-calculator">
							<p><a href="katalog.php?t=sship" class="shipping-calculator-button"><phpdac>cmsrt.slocale use _SHIPCOST</phpdac></a></p>

                            <p><a data-toggle="collapse" aria-expanded="false" aria-controls="calculator" href="#calculator" aria-expanded="true" class="shipping-calculator-button">Calculate Shipping</a></p>
							<!-- aria-expanded="false" --> 
                            <div id="calculator" class="shipping-calculator-form collapse"> <!-- collapse -->
        ...
        <div class="wc-proceed-to-checkout">
			...
			<phpdac>
				cmsrt.nvl use shcart.status+
					<?php
						$submit = '<input type="submit" class="button" name="FormAction" value="' . _v('shcart.order') . '">';
						return $submit;
					?>
				++1
			</phpdac>			
