				...
				<h3><phpdac>cmsrt.slocale use _DOCTYPE</phpdac>: $30$</h3>
				...
				<p>
					<input  class="le-checkbox big" type="checkbox" name="autosub" value="1"d />
                    <a class="simple-link bold" href="#"><phpdac>cmsrt.slocale use _REGUSRINFO01</phpdac></a>
				</p>
				
				<h3><phpdac>cmsrt.slocale use _REGUSRDELIVADDRESS</phpdac></h3>
				<p>	
					<p><phpdac>cmsrt.slocale use _REGUSRWARN02</phpdac></p>
				</p>
				
				<p id="billing_address_1_field" class="form-row form-row form-row-wide address-field validate-required"><label class="" for="billing_address_1"><phpdac>cmsrt.slocale use _STREETNO</phpdac> <abbr title="required" class="required">*</abbr></label><input type="text" value="<phpdac>cmsrt.nvldac2 use address_d+cmsrt.echostr:address_d++</phpdac>" placeholder="<phpdac>cms.slocale use _STREETNO</phpdac>" id="billing_address_1" name="address_d" class="input-text "></p>

				<p id="billing_address_2_field" class="form-row form-row form-row-wide address-field"><input type="text" value="<phpdac>cmsrt.nvldac2 use area_d+cmsrt.echostr:area_d++</phpdac>" placeholder="<phpdac>cmsrt.slocale use _AREA</phpdac>" id="billing_address_2" name="area_d" class="input-text "></p>
				
				<p id="billing_postcode_field" class="form-row form-row form-row-wide address-field validate-postcode validate-required" data-o_class="form-row form-row form-row-last address-field validate-required validate-postcode"><label class="" for="billing_postcode"><phpdac>cmsrt.slocale use _POBOX</phpdac></label> <abbr title="required" class="required">*</abbr></label><input type="text" value="<phpdac>cmsrt.nvldac2 use zip_d+cmsrt.echostr:zip_d++</phpdac>" placeholder="" id="billing_postcode" name="zip_d" class="input-text "></p>
				
				<p>
					<phpdac>cmsrt.slocale use _REGUSRWARN01</phpdac>
				</p>
				
				<button type="submit" class="button"><phpdac>cmsrt.slocale use _SUBMIT</phpdac></button>
