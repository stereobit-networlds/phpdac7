	...
	<div class="tabs-block col-lg-8">
		<div class="products-carousel-tabs">
			<ul class="nav nav-inline">
				<li class="nav-item"><a class="nav-link active" href="#tab-products-1" data-toggle="tab"><phpdac>cmsrt.slocale use _fpprosfores</phpdac></a></li>
				<li class="nav-item"><a class="nav-link" href="#tab-products-2" data-toggle="tab"><phpdac>cmsrt.slocale use _fpnewarrivals</phpdac></a></li>
				<li class="nav-item"><a class="nav-link" href="#tab-products-3" data-toggle="tab"><phpdac>cmsrt.slocale use _fptopsales</phpdac></a></li>
			</ul>

			<div class="tab-content">
				<div class="tab-pane active" id="tab-products-1" role="tabpanel">
					<div class="woocommerce columns-3">
						<phpdac>shkatalogmedia.show_menu_items use 6+3+fpproducts-tab+1+prosfores+fpproducts-tab-line</phpdac>
					</div>
				</div>

				<div class="tab-pane" id="tab-products-2" role="tabpanel">
					<div class="woocommerce columns-3">
						<phpdac>shkatalogmedia.show_menu_items use 6+3+fpproducts-tab+1+arrivals+fpproducts-tab-line</phpdac>
					</div>
				</div>

				<div class="tab-pane" id="tab-products-3" role="tabpanel">
					<div class="woocommerce columns-3">
						<phpdac>shkatalogmedia.show_menu_items use 6+3+fpproducts-tab+1+topsales+fpproducts-tab-line</phpdac>
					</div>
				</div>
			</div>
		</div>
