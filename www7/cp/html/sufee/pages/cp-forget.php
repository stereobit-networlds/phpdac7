                ...
                <div class="login-form">
                    <form  method="POST" action=".">
                        <div class="form-group">
                            ...
                            <input type="email" name="myemail" class="form-control" placeholder="Username">
							<label>Captcha</label>
							<br/><img src="cp.php?t=captchaimage" alt="captcha"/>
							<br/><input type="email" name="mycaptcha" class="form-control" placeholder="Capthca">
                        </div>
