...
<footer id="footer" class="color-bg">
    ...
    <div class="container">
        <div class="row no-margin widgets-row">
            <div class="col-xs-12  col-sm-4 no-margin-left">
                <phpdac>frontpage.include_part use /parts/widgets/footer/featured-products-footer.php</phpdac>
            </div><!-- /.col -->

            <div class="col-xs-12 col-sm-4 ">
                <phpdac>frontpage.include_part use /parts/widgets/footer/on-sale-products-footer.php</phpdac>
            </div><!-- /.col -->

            <div class="col-xs-12 col-sm-4 ">
                <phpdac>frontpage.include_part use /parts/widgets/footer/top-rated-products-footer.php</phpdac>
            </div><!-- /.col -->
    ...
    <phpdac>frontpage.nvldac2 use nosubform++frontpage.include_part:/parts/widgets/footer/subscribe-form.php</phpdac>
    ...
    <div class="link-list-row">
        <div class="container no-padding">
            <div class="col-xs-12 col-md-4 ">
                <phpdac>frontpage.include_part use /parts/widgets/footer/contact-info-footer.php</phpdac>
            </div>

            <div class="col-xs-12 col-md-8 no-margin">
                <phpdac>frontpage.include_part use /parts/widgets/footer/links-footer.php</phpdac>
            </div>
        </div><!-- /.container -->
    </div><!-- /.link-list-row -->
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright"> 
					...
					all rights reserved.  
					&nbsp;|&nbsp; <a href="https://x3studio.eu" target="_blank"> x3studio</a>
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
