...
'prjpath' => '/',
'dachost' => '34.83.184.99',
'dacport' => '19123',
'app' => '',/*'/xampp-phpdac7/vendor/stereobit/cpdac7.phar',*/
'cppath' =>'/xampp-basis/cp',
'key' => '992df1d2d0a0f90a183a8c6a022e9931', 
);
...
function get($call=null) {
    global $dh, $dp;		
    if ((_MODE_ < 1) || ($call==null)) return false;   
...
function getT($call=null, $port=null) {   
    ...
    if ((_MODE_ < 2) || ($call==null)) return false;	   
...
if (($dac) && (!$localscript)) { 
	...
	__log("Fetch remote ($__id):".$_SERVER['PHP_SELF']);	
	die();
} //else continue
__log("Fetch local ($__id):".$_SERVER['PHP_SELF']);
?>