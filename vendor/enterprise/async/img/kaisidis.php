...
return array (
	...
	'categories' => array(strval(htmlspecialchars_decode($element->group->name)), strval(htmlspecialchars_decode($element->group->category->name)), strval(htmlspecialchars_decode($element->group->category->subcategory->name))),
