...
<body style="margin:0;padding:0">
                 ...
                 <div class="span12">
					...
					<div id="edit_code" class="control-group">
						<form name="form1" method="post" action="#" class="form-horizontal">
							<textarea wrap="virtual" id="codedata" class="span12" name="codedata" rows="20"><phpdac>rccmshtml.fetchHtmlData</phpdac></textarea>
							<input type="hidden" name="id" value="<phpdac>fronthtmlpage.echostr use id</phpdac>">									
							<input type="hidden" name="FormName" value="codeform">									
							<input type="hidden" name="FormAction" value="cpcmshtmlsave">									
   ...
   <script src="js/common-scripts.js"></script> 
	...
	<script language="Javascript" type="text/javascript" src="<phpdac>rccmshtml.editAreaJS</phpdac>"></script>
