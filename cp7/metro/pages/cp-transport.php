...
<body class="fixed-top">
   ...
   <!-- END JAVASCRIPTS -->  
   <script>
	function editform() {var str = arguments[0]; $('#crmform').load("cptransport.php?t=cpitemqfetch&id="+str);}
	function deleteform() {var str = arguments[0]; $('#crmform').load("cptransport.php?t=cpitemqdel&id="+str);}
   </script>
