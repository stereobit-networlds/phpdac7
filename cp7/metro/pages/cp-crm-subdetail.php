...
<div id="crmshowdetails"></div>
<?METRO/INDEX?>  
<script>
  function showdetails() {var str = arguments[0]; $('#crmshowdetails').load("cpcrm.php?t=cpcrmmoduledtl&data="+str+"&module=<phpdac>fronthtmlpage.echostr use module</phpdac>");}
</script> 
</body>
<!-- END BODY -->
</html>