...
function show_body() { var taskid = arguments[0];  sndReqArg('cpbulkmail.php?t=cploadframe&id='+taskid,'mailbody');}		
function enable(){ var id = arguments[0]; sndReqArg('cpbulkmail.php?t=cpactivatequeuerec&rec='+id,'mailbody');}		
function disable(){ var id = arguments[0]; sndReqArg('cpbulkmail.php?t=cpdeactivatequeuerec&rec='+id,'mailbody');}
	</script>   
   <!-- END JAVASCRIPTS --> 
