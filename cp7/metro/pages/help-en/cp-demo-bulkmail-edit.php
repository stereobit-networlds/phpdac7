                ...
                <div class="span12">
                    <div class="widget box purple">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Content wizard</span>
                            </h4>
                        <span class="tools">
                        ...
                        <div class="widget-body">
                            <form id="tForm" method="post" action="cpbulkmail.php?t=cpsavemailadv&editmode=1" class="form-horizontal">
                                ...
                                <ul>
                                    ...
                                    <li<phpdac>fronthtmlpage.nvl use rcbulkmail.ulistselect+ class="active"++</phpdac>><a href="#tabsleft-tab2" data-toggle="tab"><span class="strong">Step 2</span> <span class="muted">Distribution lists</span></a></a></li>
                                    <li><a href="#tabsleft-tab3" data-toggle="tab"><span class="strong">Step 3</span> <span class="muted">Message Options</span></a></a></li>
                                    <li><a href="#tabsleft-tab4" data-toggle="tab"><span class="strong">Step 4</span> <span class="muted">Message Details</span></a></a></li>
<!--hpdac>nvl use rcbulkmail.iscollection++<li><a href="#tabsleft-tab5" data-toggle="tab"><span class="strong">Step 5</span> <span class="muted">Collection</span></a></a></li>+0</phpda-->									
                                </ul>
                                    ...
                                    <div class="tab-pane" id="tabsleft-tab1">
										...
										<div class="control-group">
											...
											<div class="controls">
                                        		...
                                        		<phpdac>fronthtmlpage.calldpc_method use rcbulkmail.ckeditorjs</phpdac>										
											</div>
										</div>
										</form>
										<!-- END FORM-->
                                    ...
                                    <div class="tab-pane <phpdac>fronthtmlpage.nvl use rcbulkmail.ulistselect+ active++</phpdac>" id="tabsleft-tab2">
										...
										<div class="control-group">
											...
											<div id="select_ulists" class="controls">
												...
												<!--/select-->
												<phpdac>rcbulkmail.uListSelect</phpdac>
											</div>
										</div>
										<div class="control-group">
...
<!--hpdac>nvl use rcbulkmail.iscollection++<div class="tab-pane" id="tabsleft-tab5"><h3>Collection options</h3><div class="control-group"><label class="control-label">Use prices</label><div class="controls"><div id="normal-toggle-button"><input name="uprice" type="checkbox" checked="checked"></div></div></div></div>+0</phpda-->									
    ...
    $('#startTour').click(function(){
          options = {
            data : [
              ...
              { element : '#edit_template', 'tooltip' : 'Μεταβολή εικαστικού', 'position' : 'Β', 'text' : '<h3>Εικαστικό θέμα</h3><p>Έχετε την δυνατότητα να αλλάξετε στοιχεία του εικαστικού θέματος που επιλέξατε. Μπορείτε να προσθέσετε μια εικόνα ή κείμενο.</p>' },
