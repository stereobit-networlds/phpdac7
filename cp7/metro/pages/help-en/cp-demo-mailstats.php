                     ...
                     <div class="widget blue">
                         ...
                         <div class="widget-body">
                             <ul class="item-list scroller padding"  style="overflow: hidden; width: auto; " data-always-visible="1">
								 <phpdac>rcbulkmail.getUnsubs use notification-warning+3</phpdac>							 
                                 <phpdac>rcbulkmail.getClicks use notifications+3</phpdac>
								 <phpdac>rcbulkmail.getViews use notification-success+3</phpdac>
                             </ul>
                             <div class="space10"></div>
