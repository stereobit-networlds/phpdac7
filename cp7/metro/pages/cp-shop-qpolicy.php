                 ...
                 <div class="span12">
					...
					<div id="edit_form" class="control-group">
						<form name="form1" method="post" action="#" class="form-horizontal">
							<textarea wrap="virtual" id="formdata" class="span12" name="formdata" rows="20" autowrap><phpdac>rcshop.fetchQPolicyData</phpdac></textarea>
							...
							<input type="hidden" name="FormAction" value="cpshopformsubdetail">									
