...
<body class="fixed-top" onLoad="init()">
   ...
   <!-- END JAVASCRIPTS -->  
   <script>
	function editform() {var str = arguments[0]; $('#proform').load("cpprocess.php?t=cpproshow&id="+str);}
	function showstack() {var str = arguments[0]; $('#proform').load("cpprocess.php?t=cpstackshow&id="+str);}
	function showrunstack() {var str = arguments[0]; $('#proform').load("cpprocess.php?t=cpstackrunshow&id="+str);}
   </script>
