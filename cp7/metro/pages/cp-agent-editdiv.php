                 ...
                 <div class="span12">
					...
					<div id="edit_form" class="control-group">
						<form name="form1" method="post" action="#" class="form-horizontal">
							<textarea wrap="virtual" id="formdata" class="span12" name="formdata" rows="20" autowrap><phpdac>rcagent.fetchDivScript</phpdac></textarea>
							<input type="hidden" name="id" value="<phpdac>cms.echostr use id</phpdac>">									
							<input type="hidden" name="FormName" value="agndivscript">									
							<input type="hidden" name="FormAction" value="cpagndivsave">									
							<input type="submit" name="save" value="<phpdac>cms.slocale use _save</phpdac>">
						</form>
					</div>				
                 </div>
             </div>
