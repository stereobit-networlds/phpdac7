...
class jq_grid {
	...
	function javascript() {
		...
		if (iniload('JAVASCRIPT')) {
            ...
            $js->load_js('jqgrid55/js/jquery-1.11.0.min.js');
			//$js->load_js('//ajax.googleapis.com/ajax/libs/jqueryui/1.12.0/jquery-ui.min.js');//html load            
			$js->load_js('jqgrid55/js/i18n/grid.locale-en.js'); //html load			
			$js->load_js('jqgrid55/js/jquery.jqGrid.min.js'); //html load
			unset ($js);
		}
