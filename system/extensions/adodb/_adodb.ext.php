 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
    ...
    //GetGlobal('controller')->include_dpc('system/extensions/adodb/adodb-time.inc.php');//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< SHARED MEM
	...
	if (PHP_VERSION < 5) 
	  ...
	  //GetGlobal('controller')->include_dpc('system/extensions/adodb/adodb-php4.inc.php');
	else 
	  include_once(ADODB_DIR.'/adodb-iterator.inc.php');
	  //GetGlobal('controller')->include_dpc('system/extensions/adodb/adodb-iterator.inc.php');
   /**
